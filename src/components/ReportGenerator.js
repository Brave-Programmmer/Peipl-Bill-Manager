...
export default function ReportGenerator({
  ...
  const generateReport = () => {
    ...
    if (reportType === "summary") {
      ...
      const sentFiles = filteredFiles.filter(
        (file) => trackingData.bills?.[file.path]?.sentMonth,
      ).length;
      ...
      filteredFiles.forEach((file) => {
        ...
        const billMonth =
          trackingData.bills?.[file.path]?.billMonth || "Unknown";
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="space-y-2">
                        {Object.entries(generatedReport.byType).map(
                          ([type, count]) => (
                    ...
                    <div>
                      ...
                      <div className="space-y-2 max-h-40 overflow-y-auto">
                        {Object.entries(generatedReport.byMonth).map(
                          ([month, count]) => (
